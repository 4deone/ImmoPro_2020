...
public class PostsAdaptor extends RecyclerView.Adapter<PostsAdaptor.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        ...
        try{
            ...
            if (creator.equals(myUID)){
                holder.itemUserNameTv.setText("Vous");
            }else{
                holder.itemUserNameTv.setText(name);
            }
        }catch(Exception e){
        ...
        try {
            Picasso.get().load(avatar).placeholder(R.drawable.ic_user).into(holder.itemUserAvatarIv, new Callback() {
                @Override
                public void onSuccess() {
